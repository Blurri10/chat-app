...
export default function Card({user, navigateTo}) {
    ...
    const details = data[user - 1];
    const idx = details.chat.length - 1;
    const latestChat = details.chat[idx]
    const lastMessage = Object.keys(latestChat).slice(-1).toString();
    const message = latestChat[lastMessage].message.substring(0, 30);
    const timeStamp = latestChat[lastMessage].timeStamp;
    ...
    return (
        <div className="Card" onClick={HandleClick}>
            <div>
                <div className="photo">
                    <img src={details.profilePictureURL} alt="profile picture"/>
                </div>
            ...
            <div>
                <div className="time">
                    <p>{timeStamp}</p>
                    {details.unreadCount !== 0 && <div className="unread">{details.unreadCount}</div>}
                </div>
