...
export default function ChatPage({user}) {
    ...
    if (user === 0) {
        return (
            <div className="ChatPage none">Tap on a chat to open it</div>
        )
    }
    else {
        const data = [
        ...
        return (
            <div className="ChatPage">
                <Top name={details.name} url={details.profilePictureURL}/>
                <Messages chat={details.chat}/>
                <Bottom name={details.name}/>
            </div>
        )
    }
